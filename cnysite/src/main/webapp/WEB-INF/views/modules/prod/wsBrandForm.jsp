...
<body>
	...
	<form:form id="inputForm" modelAttribute="wsBrand" action="${ctx}/prod/wsBrand/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="cnname" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="description" htmlEscape="false" maxlength="2500" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="logo" type="files" uploadPath="/prod/wsBrand" selectMultiple="false"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="websiteurl" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">品牌故事：</label>
			<div class="controls">
				<form:input path="brandstory" htmlEscape="false" maxlength="2500" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
