	...
	<section id="login_section" class="active">
		...
		<article data-scroll="true" id="login_article">
			<div class="indented">
				...
				<button id="btn1" class=" block">登录11</button>
...
<script type="text/javascript">
    ...
    $('#btn1').on('click',function () {
        ...
        var mobileLogin=$('input[name="mobileLogin"]').val();
        $.ajax({
            type: 'POST',
            url: 'http://localhost:8080${ctx}/login',
            // data to be added to query string:
            data: { username:username,password:password,mobileLogin:mobileLogin,validateCode:'' },
    ...
    // http://cny.s1.natapp.cc/cnysite/a/schoolmanage/student/form?id=
</script>
</body>
</html>