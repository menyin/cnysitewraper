...
<script type="text/javascript">
	...
	function ${input}Preview(){
		...
		if ($("#${input}Preview").text() == ""){
			<%--$("#${input}Preview").html("<li style='list-style:none;padding-top:5px;'>无</li>"); cny_note--%>
			$("#${input}Preview").html("<li style='list-style:none;padding-top:5px;'></li>");/*不需要显示多余的东西cny_add*/
		}
	}
	${input}Preview();
</script>